...
--
-- Host: 127.0.0.1
-- Tempo de geração: 07-Fev-2025 às 21:01
...
--
-- Banco de dados: `joaoapauloamaralestoque`
--
CREATE DATABASE IF NOT EXISTS `joaoapauloamaralestoque` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `joaoapauloamaralestoque`;
...
(130, 'Edmar', 'Rua da Praia s/n', 'Salvador', '30079300', 'BA', '234632842349', 7121),
...
(260, 'Susana', 'Rua Lopes Mendes 12', 'Niterói', '30046-500', 'RJ', '217635712329', 2530),
...
INSERT INTO `item_pedido` (`Numpedido`, `COD_produto`, `QTDE`) VALUES
(121, 25, 10),
(121, 31, 35),
(97, 77, 20),
(101, 31, 9),
...
INSERT INTO `pedido` (`NumPedido`, `prazo_entrega`, `COD_cliente`, `COD_vendedor`) VALUES
(91, 20, 260, 11),
(97, 20, 720, 101),
(98, 20, 410, 209),
(101, 15, 720, 101),
